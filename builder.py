...
class make_env:
    ...
    def get_src(self) -> None:
        subprocess.run(['git', 'clone', 'https://github.com/cikzGitt/greedyhms.git'], cwd=self.build_dir)
        shutil.move(os.path.join(self.build_dir, 'greedyhms', 'src'), self.build_dir)
